...
function announceWinner() {
  ...
  showCongratulations();
  const winnerDOM2 = document.getElementById('winner');
  console.log(winnerDOM2);

  if(winnerDOM2 && winnerDOM2.innerText === "You"){
    updatePlayerScore(1)
  }else{
  console.log("lost");
  }
...
// Function to send the player's score to the database
